...
10    format('  Frequency (timesteps) of Shortwave Radiation calc:  ',i5/, &
   ...
   subroutine radiation_tend( &
      ...
      character(len=3)         :: c3
      logical                  :: idrf
      type(rad_out_t), pointer :: rd  ! allow rd_out to be optional by allocating a local object if argument is not present
   ...
   subroutine radiation_output_sw(lchnk, ncol, icall, rd, pbuf, cam_out)
      ...
      call outfld('QRSC'//diag(icall),     rd%qrsc/cpair, pcols, lchnk)
